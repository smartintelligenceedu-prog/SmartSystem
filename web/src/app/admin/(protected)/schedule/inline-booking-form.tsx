...
export function InlineBookingForm({
  ...
  // Booth/roadshow/school-visit bookings often have no existing customer
        ...
        <form action={formAction} className="space-y-4">
          <div className="flex gap-2">
            <Button
              ...
              disabled={isPending}
            >
              {ct("schedule.booking.mode_existing")}
            </Button>
          ...
          {mode === "booth" ? (
            ...
            <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
              <div className="space-y-2">
                <Label htmlFor="new_customer_name">{ct("schedule.booking.new_customer_name_label")}</Label>
                <Input id="new_customer_name" name="new_customer_name" required />
              </div>
              <div className="space-y-2">
                <Label htmlFor="new_customer_phone">{ct("schedule.booking.new_customer_phone_label")}</Label>
                <Input id="new_customer_phone" name="new_customer_phone" type="tel" required />
              </div>
              <div className="space-y-2 sm:col-span-2">
                <Label htmlFor="new_child_name">{ct("schedule.booking.new_child_name_label")}</Label>
                <Input id="new_child_name" name="new_child_name" />
              </div>
            </div>
          )}
          ...
          <div className="flex gap-2">
            <Button
              type="submit"
              disabled={isPending || (mode === "existing" && (!selectedCustomer || !subjectValue))}
            >
